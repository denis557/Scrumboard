...
import MemberContextMenu from "../../contextMenus/memberContextMenu/memberContextMenu.jsx";

function AllMembersPopup({ toggleIsAllMembers, pageId, teamMembersInfo }) {
  const memberContextMenuRef = useRef(null);
  ...
  function handleMemberContext(e, clickedMember) {
    e.preventDefault();

    const memberContextMenuAttr = memberContextMenuRef.current.getBoundingClientRect();
    ...
    if(isLeft) {
      ...
      x = e.clientX - memberContextMenuAttr.width
    }
  ...
  return (
    <div className="modal_body">
      ...
      <div className="allMembers">
        ...
        <MemberContextMenu memberContextMenuRef={memberContextMenuRef} isToggled={memberContext.toggled} positionX={memberContext.position.x} positionY={memberContext.position.y} buttons={[
          {
            text: 'view profile',
