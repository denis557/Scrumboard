        ...
        <div className="main">
            ...
            <form onSubmit={handleSignup} className='body'>
                ...
                <div className='nameWrapper'>
                    ...
                    <input type='text' placeholder='Surname' className='inputName' value={surname} onChange={(e) => setSurname(e.target.value)} />
                </div>
                <input type='email' placeholder='Email' className='input' value={email} onChange={(e) => setEmail(e.target.value)} />
                <div className='password'>
                    <input type={isShowPassword ? 'text' : 'password'} placeholder='Password' className='inputPassword' value={password} onChange={(e) => setPassword(e.target.value)} />
                    {isShowPassword ? 
